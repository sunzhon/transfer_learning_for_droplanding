...
# baseline
#python main.py --config DANN/DANN.yaml --model_selection baseline --n_epoch 100 --tgt_domain 4subjects_kam_norm_landing_data.hdf5 --config_alias_name baseline_v13 --investigation_results_folder baseline_v13 | tee baseline.log
...
# repeated DANN
python main.py --config DANN/DANN.yaml --model_selection DANN --n_epoch 100 --tgt_domain repeated_4subjects_kam_norm_landing_data.hdf5 --tst_domain 4subjects_kam_norm_landing_data.hdf5 --config_alias_name repeated_dann_v3 --investigation_results_folder repeated_dann_v3 | tee DANN.log
